...
呈尚策划工具箱是一个基于 Tauri 2.x 框架开发的专业级桌面应用，整合了20个精心设计的专业工具，为不同岗位提供一站式的工作解决方案。应用采用现代化的 UI 设计和企业级安全保护机制，提供流畅、安全、高效的用户体验。
...
| 分类 | 数量 | 主要功能 |
|------|------|----------|
| 运营工具 | 11个 | 店铺运营管理、数据分析、AI助手、周报生成等 |
| 美工工具 | 2个 | 图片采集、产品数据处理 |
| 销售工具 | 2个 | 销售数据统计、报告生成 |
